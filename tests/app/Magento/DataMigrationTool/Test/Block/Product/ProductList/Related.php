...
namespace Magento\DataMigrationTool\Test\Block\Product\ProductList;

use Magento\DataMigrationTool\Test\Block\Product\ProductList\Related\ProductItem as RelatedProductItem;
...
class Related extends PromotedSection
{
    ...
    public function getProductItem(FixtureInterface $product)
    {
        ...
        return $this->blockFactory->create(
            'Magento\DataMigrationTool\Test\Block\Product\ProductList\Related\ProductItem',
