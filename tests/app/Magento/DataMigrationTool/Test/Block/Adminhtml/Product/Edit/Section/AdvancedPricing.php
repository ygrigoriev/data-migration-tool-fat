...
use Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Edit\Section\AdvancedPricing\OptionTier;
...
class AdvancedPricing extends Section
{
    ...
    public function getTierPriceForm(SimpleElement $element = null)
    {
        ...
        return $this->blockFactory->create(
            'Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Edit\Section\AdvancedPricing\OptionTier',
            ['element' => $element]
        );
    }
}
