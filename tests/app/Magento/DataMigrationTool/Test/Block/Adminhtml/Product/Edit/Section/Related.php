...
use Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Edit\Section\Related\Grid;
...
class Related extends Section
{
    ...
    protected function getRelatedGrid(SimpleElement $element = null)
    {
        ...
        return $this->blockFactory->create(
            '\Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Edit\Section\Related\Grid',
            ['element' => $element]
        );
    }
}
