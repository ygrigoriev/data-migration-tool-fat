...
namespace Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Attribute\Edit;

use Magento\Mtf\ObjectManager;
use Magento\Mtf\Client\Element\SimpleElement;
use Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Attribute\Edit\Tab\Options\Option;
...
class Options extends SimpleElement
{
    ...
    protected function getFormInstance(SimpleElement $element = null)
    {
        return ObjectManager::getInstance()->create(
            'Magento\DataMigrationTool\Test\Block\Adminhtml\Product\Attribute\Edit\Tab\Options\Option',
