...
namespace Magento\DataMigrationTool\Test\Block;

use Magento\DataMigrationTool\Test\Block\Product\View\CustomOptions;
use Magento\DataMigrationTool\Test\Fixture\CatalogProductSimple;
...
abstract class AbstractConfigureBlock extends Form
{
    ...
    public function getCustomOptionsBlock()
    {
        return $this->blockFactory->create(
            'Magento\DataMigrationTool\Test\Block\Product\View\CustomOptions',
